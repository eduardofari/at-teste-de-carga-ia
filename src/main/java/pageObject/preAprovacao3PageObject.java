...
public class preAprovacao3PageObject {
    ...
    public void login() {
        try {
            camposController.CampoSend(Config.getProperty("audit.login3"), userlogin, "Login");
            camposController.CampoSend(Config.getProperty("audit.senha3"), usersenha, "Senha");
