...
public class preAprovacaoPageObject {
    ...
    public void login() {
        try {
            camposController.CampoSend(Config.getProperty("audit.login"), userlogin, "Login");
            camposController.CampoSend(Config.getProperty("audit.senha"), usersenha, "Senha");
